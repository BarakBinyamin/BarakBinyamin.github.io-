...
powershell -Command "(New-Object Net.WebClient).DownloadFile('https://www.python.org/ftp/python/3.9.0/python-3.9.0b4-amd64.exe', 'python.exe')"   
powershell -Command "Invoke-WebRequest https://www.python.org/ftp/python/3.9.0/python-3.9.0b4-amd64.exe -OutFile python.exe" 
